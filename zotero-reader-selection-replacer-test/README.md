...
让论文阅读变得更轻松：在 Zotero 里打开 PDF，选中想看的内容，点击一下，就能在原文旁边看到简体中文译文。🌏💡
...
6. 🟢 等待状态灯变绿。
7. 🖱️ 选中 PDF 中的一段文字，点击“翻译”。
8. 🎉 阅读译文，需要核对时点击译文覆盖层查看原文。
...
1. 获取插件文件：
   ...
   ```text
    dist/Translator-for-Zotero-1.1.0.xpi
   ```
