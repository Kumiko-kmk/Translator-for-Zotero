(function (global) {
  ...
  const FIRST_MODEL_SELECTION_NOTICE_SHOWN_PREF =
    "extensions.reader-selection-replacer.firstModelSelectionNoticeShown";
  const FIRST_MODEL_SELECTION_NOTICE_LOCK_MS = 5000;
  const FIRST_MODEL_SELECTION_NOTICE_WARNING = "还没看呢点什么确认！";
